...
export namespace Prisma {
  ...
  */
  ...
  > = {
    ...
    meta: {
      modelProps: 'product' | 'image' | 'guest' | 'cart' | 'cartItem';
  ...
  type GetGuestGroupByPayload<T extends GuestGroupByArgs> =
    Prisma.PrismaPromise<
      Array<
  ...
  > = $Extensions.GetSelect<
    {
      ...
      userAgent?: boolean;
      createdAt?: boolean;
      cart?: boolean | Guest$cartArgs<ExtArgs>;
    },
    ExtArgs['result']['guest']
  >;

  export type GuestSelectCreateManyAndReturn<
    ExtArgs extends $Extensions.InternalArgs = $Extensions.DefaultArgs,
  > = $Extensions.GetSelect<
    {
      id?: boolean;
  ...
  export type GuestSelectUpdateManyAndReturn<
    ExtArgs extends $Extensions.InternalArgs = $Extensions.DefaultArgs,
  > = $Extensions.GetSelect<
    {
      id?: boolean;
  ...
  export type GuestIncludeCreateManyAndReturn<
    ExtArgs extends $Extensions.InternalArgs = $Extensions.DefaultArgs,
  > = {};
  export type GuestIncludeUpdateManyAndReturn<
    ExtArgs extends $Extensions.InternalArgs = $Extensions.DefaultArgs,
  > = {};
  ...
  type GuestGetPayload<
    S extends boolean | null | undefined | GuestDefaultArgs,
  > = $Result.GetResult<Prisma.$GuestPayload, S>;
  ...
  > {
     ...
     *
     */
    createManyAndReturn<T extends GuestCreateManyAndReturnArgs>(
      args?: SelectSubset<T, GuestCreateManyAndReturnArgs<ExtArgs>>,
    ): Prisma.PrismaPromise<
      $Result.GetResult<
        Prisma.$GuestPayload<ExtArgs>,
        T,
     ...
     *
     */
    updateManyAndReturn<T extends GuestUpdateManyAndReturnArgs>(
      args: SelectSubset<T, GuestUpdateManyAndReturnArgs<ExtArgs>>,
    ): Prisma.PrismaPromise<
      $Result.GetResult<
        Prisma.$GuestPayload<ExtArgs>,
        T,
  ...
  > extends Prisma.PrismaPromise<T> {
    readonly [Symbol.toStringTag]: 'PrismaPromise';
    cart<T extends Guest$cartArgs<ExtArgs> = {}>(
      args?: Subset<T, Guest$cartArgs<ExtArgs>>,
    ): Prisma__CartClient<
      $Result.GetResult<
   ...
   */
  export type GuestCreateManyAndReturnArgs<
    ExtArgs extends $Extensions.InternalArgs = $Extensions.DefaultArgs,
  > = {
    /**
     * Select specific fields to fetch from the Guest
   ...
   */
  export type GuestUpdateManyAndReturnArgs<
    ExtArgs extends $Extensions.InternalArgs = $Extensions.DefaultArgs,
  > = {
    /**
     * Select specific fields to fetch from the Guest
  ...
  export type CartOmit<
    ExtArgs extends $Extensions.InternalArgs = $Extensions.DefaultArgs,
  > = $Extensions.GetOmit<
    'id' | 'userId' | 'guestId' | 'createdAt' | 'updatedAt',
    ExtArgs['result']['cart']
  >;
  ...
  > extends Prisma.PrismaPromise<T> {
    readonly [Symbol.toStringTag]: 'PrismaPromise';
    guest<T extends Cart$guestArgs<ExtArgs> = {}>(
      args?: Subset<T, Cart$guestArgs<ExtArgs>>,
    ): Prisma__GuestClient<
      $Result.GetResult<
        Prisma.$GuestPayload<ExtArgs>,
        T,
  ...
  export type GuestScalarFieldEnum =
    (typeof GuestScalarFieldEnum)[keyof typeof GuestScalarFieldEnum];
  ...
  export type GuestCreateInput = {
    ...
    cart?: CartCreateNestedOneWithoutGuestInput;
  };
  ...
  export type GuestUncheckedCreateInput = {
    ...
    userAgent?: string | null;
    createdAt?: Date | string;
    cart?: CartUncheckedCreateNestedOneWithoutGuestInput;
  };
  ...
  export type GuestUpdateInput = {
    ...
    cart?: CartUpdateOneWithoutGuestNestedInput;
  };
  ...
  export type GuestUncheckedUpdateInput = {
    ...
    userAgent?: NullableStringFieldUpdateOperationsInput | string | null;
    createdAt?: DateTimeFieldUpdateOperationsInput | Date | string;
    cart?: CartUncheckedUpdateOneWithoutGuestNestedInput;
  };
  ...
  export type CartCreateInput = {
    ...
    guest?: GuestCreateNestedOneWithoutCartInput;
  ...
  export type CartUpdateInput = {
    ...
    guest?: GuestUpdateOneWithoutCartNestedInput;
  ...
  export type CartCreateNestedOneWithoutGuestInput = {
    create?: XOR<
      CartCreateWithoutGuestInput,
      CartUncheckedCreateWithoutGuestInput
    >;
    connectOrCreate?: CartCreateOrConnectWithoutGuestInput;
    connect?: CartWhereUniqueInput;
  };

  export type CartUncheckedCreateNestedOneWithoutGuestInput = {
    create?: XOR<
      CartCreateWithoutGuestInput,
      CartUncheckedCreateWithoutGuestInput
    >;
  ...
  export type CartUpdateOneWithoutGuestNestedInput = {
    create?: XOR<
      CartCreateWithoutGuestInput,
      CartUncheckedCreateWithoutGuestInput
    >;
    connectOrCreate?: CartCreateOrConnectWithoutGuestInput;
    upsert?: CartUpsertWithoutGuestInput;
    disconnect?: CartWhereInput | boolean;
    delete?: CartWhereInput | boolean;
    connect?: CartWhereUniqueInput;
    update?: XOR<
      XOR<
        CartUpdateToOneWithWhereWithoutGuestInput,
        CartUpdateWithoutGuestInput
      >,
      CartUncheckedUpdateWithoutGuestInput
    >;
  };

  export type CartUncheckedUpdateOneWithoutGuestNestedInput = {
    create?: XOR<
      CartCreateWithoutGuestInput,
      CartUncheckedCreateWithoutGuestInput
    >;
  ...
  export type GuestCreateNestedOneWithoutCartInput = {
    create?: XOR<
      GuestCreateWithoutCartInput,
      GuestUncheckedCreateWithoutCartInput
    >;
    connectOrCreate?: GuestCreateOrConnectWithoutCartInput;
  ...
  export type GuestUpdateOneWithoutCartNestedInput = {
    create?: XOR<
      GuestCreateWithoutCartInput,
      GuestUncheckedCreateWithoutCartInput
    >;
    ...
    update?: XOR<
      XOR<
        GuestUpdateToOneWithWhereWithoutCartInput,
        GuestUpdateWithoutCartInput
      >,
      GuestUncheckedUpdateWithoutCartInput
    >;
  };
  ...
  export type CartCreateOrConnectWithoutGuestInput = {
    where: CartWhereUniqueInput;
    create: XOR<
      CartCreateWithoutGuestInput,
      CartUncheckedCreateWithoutGuestInput
  ...
  export type CartUpsertWithoutGuestInput = {
    update: XOR<
      CartUpdateWithoutGuestInput,
      CartUncheckedUpdateWithoutGuestInput
    >;
  ...
  export type CartUpdateToOneWithWhereWithoutGuestInput = {
    where?: CartWhereInput;
    data: XOR<
      CartUpdateWithoutGuestInput,
      CartUncheckedUpdateWithoutGuestInput
  ...
  export type GuestUncheckedCreateWithoutCartInput = {
    id?: string;
    ipAddress?: string | null;
    userAgent?: string | null;
    createdAt?: Date | string;
  ...
  export type GuestCreateOrConnectWithoutCartInput = {
    where: GuestWhereUniqueInput;
    create: XOR<
      GuestCreateWithoutCartInput,
      GuestUncheckedCreateWithoutCartInput
  ...
  export type GuestUpdateToOneWithWhereWithoutCartInput = {
    where?: GuestWhereInput;
    data: XOR<
      GuestUpdateWithoutCartInput,
      GuestUncheckedUpdateWithoutCartInput
  ...
  export type GuestUpdateWithoutCartInput = {
    id?: StringFieldUpdateOperationsInput | string;
    ipAddress?: NullableStringFieldUpdateOperationsInput | string | null;
    userAgent?: NullableStringFieldUpdateOperationsInput | string | null;
    createdAt?: DateTimeFieldUpdateOperationsInput | Date | string;
  ...
  export type GuestUncheckedUpdateWithoutCartInput = {
    id?: StringFieldUpdateOperationsInput | string;
    ipAddress?: NullableStringFieldUpdateOperationsInput | string | null;
    userAgent?: NullableStringFieldUpdateOperationsInput | string | null;
    createdAt?: DateTimeFieldUpdateOperationsInput | Date | string;
